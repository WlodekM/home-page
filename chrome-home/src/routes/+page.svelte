...
<head>
    ...
    <script src="https://kit.fontawesome.com/5503a5b48d.js" crossorigin="anonymous"></script>
</head>
            ...
            <div id="content">
                <center>
                    <div id="header-container">
                        <img id="logo" src="/google_logo.svg" alt="Google Doodle" />
                    </div>
                ...
                <div id="apps-container">
                    <a href="#">
                        ...
                        <div class="label">
                            <span class="name">Your Work - CodePen</span>
                ...
                <!-- <div id="discover-container">
                    ...
                    <div id="discover-feed">
                        <a href="#" class="discover-card">
                            <img
                                src="https://images.unsplash.com/photo-1606567595334-d39972c85dbe?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" />
                            <div class="discover-card-info">
                                <p class="title">Research team spends 37 years attempting to establish human-to-bird
                                    communication.</p>
                                <p class="desc">They say they are just days away from unlocking the key to "Eep, eep" and
                                    "Chirp".</p>
                            </div>
                        </a>
                    </div>
